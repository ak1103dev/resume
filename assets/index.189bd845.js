import{j as d,r,R as m,a as g}from"./vendor.ce3d06d2.js";const u=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerpolicy&&(l.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?l.credentials="include":s.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}};u();var f="/assets/Apichan.5e036612.jpg";const e=d.exports.jsx,t=d.exports.jsxs;class x extends r.exports.Component{render(){const{info:n}=this.props;return t("div",{className:"basicInfo",children:[e("img",{className:"profileImage",src:f,alt:"apichan"}),e("h1",{children:n.name}),e("h2",{children:n.bio}),t("div",{className:"contact",children:[t("div",{className:"rowInfo",children:[e("p",{className:"p label",children:"Email"}),e("p",{className:"p",children:n.email})]}),t("div",{className:"rowInfo",children:[e("p",{className:"p label",children:"Address"}),e("p",{className:"p",children:n.address})]})]}),e("div",{className:"socialIcons",children:n.socials.map((i,a)=>e("a",{href:i.url,target:"_blank",rel:"noreferrer",children:e("i",{className:`fa fa-${i.icon} fa-4x socialIcon`})},a))}),e("style",{children:`
          .basicInfo {
            padding: 10px 20px;
          }
